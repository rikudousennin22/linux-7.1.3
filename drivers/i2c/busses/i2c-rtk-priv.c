 ...
 * Retn : 0
 */
static int rtk_i2c_set_guard_interval(struct rtk_i2c_handler *handler,
	unsigned long us)
{
	RTK_DEBUG("%s\n", __func__);
 ...
 */
static int rtk_i2c_read(struct rtk_i2c_handler *handler,
 ...
 * Retn : 0 for success, others is failed
 */
static int rtk_i2c_write(struct rtk_i2c_handler *handler, unsigned char *tx_buf,
 ...
 * Retn : N/A
 */
static void rtk_i2c_master_write(struct rtk_i2c_handler *handler, unsigned int event,
 ...
 * Retn : N/A
 */
static void rtk_i2c_master_read(struct rtk_i2c_handler *handler, unsigned int event,
	unsigned int tx_abort_source)
{
 ...
 * Retn : N/A
 */
static void rtk_i2c_master_random_read(struct rtk_i2c_handler *handler,
 ...
 * Retn : 0 for success, others is failed
 */
static int rtk_i2c_read_edid_seg(struct rtk_i2c_handler *handler,
 ...
 * Retn : 0
 */
static int rtk_i2c_set_sar(struct rtk_i2c_handler *handler,
 ...
 * Retn : 0
 */
static int rtk_i2c_slave_mode_enable(struct rtk_i2c_handler *handler,
	unsigned char on)
{
	unsigned long flags;
 ...
 * Retn : 0
 */
static int rtk_i2c_register_slave_ops(struct rtk_i2c_handler *handler,
 ...
 * Retn : 0 for success
 */
static int rtk_i2c_dump(struct rtk_i2c_handler *handler)
{
	RTK_DEBUG("%s\n", __func__);
	pr_info("=========================\n");
	pr_info("= VER : %s\n", VERSION);
 ...
 */
static struct rtk_i2c_reg_map rtk_i2c_setup_reg_base(unsigned int id,
	unsigned long base)
{
