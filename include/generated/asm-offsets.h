...
#define THREAD_SCTLR_USER 3824 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 3720 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3800 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 3816 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_FAULT_DISR 5272 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 5064 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
...
#define HOST_CONTEXT_VCPU 4760 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
...
#define TRAMP_VALIAS -12619776 /* TRAMP_VALIAS */
