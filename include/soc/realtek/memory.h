...
#define ROOTFS_NORMAL_SIZE (0x01800000) //24MB (Increased for OpenWrt rescue image)
#endif
...
/* Moved to 0x22000000 to avoid overlap with 12MB+ ROOTFS_NORMAL */
#define MEM_SLOT_PHYS_1 (0x22000000)
